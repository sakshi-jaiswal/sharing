...
public class UserRegistration extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		User user=new User(request.getParameter("fname"),request.getParameter("lname"),Integer.parseInt(request.getParameter("age")),request.getParameter("gender"),Long.parseLong(request.getParameter("cno")),request.getParameter("eid"),request.getParameter("uid"),request.getParameter("pass"));
		UserDao udsi=new UserDaoSqlImpl();
		System.out.println("In vendor registration servlet");
		try {
